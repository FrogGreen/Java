//Spring - Java Annotations Configuration - Bean Scope
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("Spring - Java Annotations Configuration - Bean Scope.xml");
