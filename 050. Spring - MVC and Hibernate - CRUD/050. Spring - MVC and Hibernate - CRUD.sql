CREATE DATABASE IF NOT EXISTS `froggreendatalist`;

DROP TABLE IF EXISTS froggreendatalist.person;
CREATE TABLE froggreendatalist.person (
...
INSERT INTO froggreendatalist.person VALUES 
