...
public class Main {
	...
	public static void createDatabaseObject() {
		...
		SessionFactory sessionFactory = new Configuration().configure("hibernate.cfgO2M.xml")
				.addAnnotatedClass(Person.class).addAnnotatedClass(PersonDetail.class).addAnnotatedClass(Car.class)
				.buildSessionFactory();
	...
	public static void deleteDatabaseObject() {
		...
		try {
			...
			PersonDetail personDetail = session.get(PersonDetail.class, 3);
