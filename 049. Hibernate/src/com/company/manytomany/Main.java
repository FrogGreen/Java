...
public class Main {
	...
	public static void checkDatabaseConnection() {
		String jdbcURL = "jdbc:mysql://localhost:3306/FrogGreenM2M?useSSL=false&serverTimezone=UTC";
	...
	public static void createDatabaseObject() {
		...
		SessionFactory sessionFactory = new Configuration().configure("hibernate.cfgM2M.xml")
