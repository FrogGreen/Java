package com.company.onetoone.bidrectional;
...
public class Main {
	...
	public static void createDatabaseObject() {
		...
		SessionFactory sessionFactory = new Configuration().configure("hibernate.cfgO2Obi.xml")
	...
	public static void deleteDatabaseObject() {
		...
		try {
			...
			PersonDetail personDetail = session.get(PersonDetail.class, 2);
			Person person = personDetail.getPerson();
