...
@RestController
@RequestMapping("/springboothibernatewithservicerestapi")
public class PersonRestControllerHibernateWithService {

	private PersonService personService;

	@Autowired
	public PersonRestControllerHibernateWithService(@Qualifier("personServiceHibernateImpl") PersonService personService) {
