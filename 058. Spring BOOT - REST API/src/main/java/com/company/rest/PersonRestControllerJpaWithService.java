...
@RestController
@RequestMapping("/springbootjpawithservicerestapi")
public class PersonRestControllerJpaWithService {

	private PersonService personService;

	@Autowired
	public PersonRestControllerJpaWithService(@Qualifier("personServiceJpaImpl") PersonService personService) {
