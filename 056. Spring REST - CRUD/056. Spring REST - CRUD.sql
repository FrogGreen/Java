CREATE DATABASE IF NOT EXISTS `froggreenrestcrud`;

DROP TABLE IF EXISTS froggreenrestcrud.person;
CREATE TABLE froggreenrestcrud.person (
...
INSERT INTO froggreenrestcrud.person VALUES 
